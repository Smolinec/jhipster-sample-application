...
public class Value implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JoinTable(name = "value_temperature",
    ...
    public Value timestamp(ZonedDateTime timestamp) {
    ...
    public Value temperature(Temperature temperature) {
    ...
    public Value temperatures(Set<Temperature> temperatures) {
        this.temperatures = temperatures;
        return this;
    }

    public Value addTemperature(Temperature temperature) {
        this.temperatures.add(temperature);
        temperature.getValues().add(this);
        return this;
    }

    public Value removeTemperature(Temperature temperature) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((Value) o).id);
    }
